...
( cd "${dir}" && bjam -d+2 --prefix="${prefix}" --enable-multitarget --with-binutils=2.22.51 --with-gmp-for-gcc=latest --with-mpfr-for-gcc=3.0.1  --with-mpc-for-gcc=latest --with-isl-for-gcc=system --with-cloog-for-gcc=system --enable-compilers=gcc-previous,gcc-previous-snapshot                                     --enable-gmp --enable-mpfr --enable-mpc --enable-isl --enable-cloog --enable-ppl --enable-icu4c=49.1.1 --with-mpi-backend=openmpi                --enable-clang --enable-valgrind --concurrency=3 --with-awacs=\"${prefix}/bin/twitter.rb\" --with-stream="$log_file_full_path" >> "$log_file_full_path" 2>&1 )

( cd "${dir}" && bjam -d+2 --prefix="${prefix}" --enable-multitarget --with-binutils=2.22.51 --with-gmp-for-gcc=latest --with-mpfr-for-gcc=3.0.1  --with-mpc-for-gcc=latest --with-isl-for-gcc=system --with-cloog-for-gcc=system --enable-compilers=gcc-current,gcc-current-snapshot                                       --enable-gmp --enable-mpfr --enable-mpc --enable-isl --enable-cloog --enable-ppl --enable-icu4c=49.1.1 --with-mpi-backend=openmpi                --enable-clang --enable-valgrind --concurrency=3 --with-awacs=\"${prefix}/bin/twitter.rb\" --with-stream="$log_file_full_path" >> "$log_file_full_path" 2>&1 )

( cd "${dir}" && bjam -d+2 --prefix="${prefix}" --enable-multitarget --with-binutils=2.22.90 --with-gmp-for-gcc=latest --with-mpfr-for-gcc=latest --with-mpc-for-gcc=latest --with-isl-for-gcc=latest --with-cloog-for-gcc=latest --enable-compilers=gcc-snapshot                                                           --enable-gmp --enable-mpfr --enable-mpc --enable-isl --enable-cloog --enable-ppl --enable-icu4c=49.1.1 --with-mpi-backend=openmpi                --enable-clang --enable-valgrind --concurrency=3 --with-awacs=\"${prefix}/bin/twitter.rb\" --with-stream="$log_file_full_path" >> "$log_file_full_path" 2>&1 )

( cd "${dir}" && bjam -d+2 --prefix="${prefix}" --enable-multitarget --with-binutils=2.22.51 --with-gmp-for-gcc=latest --with-mpfr-for-gcc=3.0.1  --with-mpc-for-gcc=latest --with-isl-for-gcc=system --with-cloog-for-gcc=system --enable-compilers=clang-latest-libstdc++-current,clang-latest-libstdc++-current-snapshot --enable-gmp --enable-mpfr --enable-mpc --enable-isl --enable-cloog --enable-ppl --enable-icu4c=49.1.1 --with-mpi-backend=openmpi                               --enable-valgrind --concurrency=3 --with-awacs=\"${prefix}/bin/twitter.rb\" --with-stream="$log_file_full_path" >> "$log_file_full_path" 2>&1 )

( cd "${dir}" && bjam -d+2 --prefix="${prefix}" --enable-multitarget --with-binutils=2.22.90 --with-gmp-for-gcc=latest --with-mpfr-for-gcc=latest --with-mpc-for-gcc=latest --with-isl-for-gcc=latest --with-cloog-for-gcc=latest --enable-compilers=clang-latest-libstdc++-snapshot                                        --enable-gmp --enable-mpfr --enable-mpc --enable-isl --enable-cloog --enable-ppl --enable-icu4c=49.1.1 --with-mpi-backend=openmpi                               --enable-valgrind --concurrency=3 --with-awacs=\"${prefix}/bin/twitter.rb\" --with-stream="$log_file_full_path" >> "$log_file_full_path" 2>&1 )

( cd "${dir}" && bjam -d+2 --prefix="${prefix}" --enable-multitarget --with-binutils=2.22.51 --with-gmp-for-gcc=latest --with-mpfr-for-gcc=3.0.1  --with-mpc-for-gcc=latest --with-isl-for-gcc=system --with-cloog-for-gcc=system --enable-compilers=clang-trunk-libstdc++-current,clang-trunk-libstdc++-current-snapshot   --enable-gmp --enable-mpfr --enable-mpc --enable-isl --enable-cloog --enable-ppl --enable-icu4c=49.1.1 --with-mpi-backend=openmpi                               --enable-valgrind --concurrency=3 --with-awacs=\"${prefix}/bin/twitter.rb\" --with-stream="$log_file_full_path" >> "$log_file_full_path" 2>&1 )

( cd "${dir}" && bjam -d+2 --prefix="${prefix}" --enable-multitarget --with-binutils=2.22.90 --with-gmp-for-gcc=latest --with-mpfr-for-gcc=latest --with-mpc-for-gcc=latest --with-isl-for-gcc=latest --with-cloog-for-gcc=latest --enable-compilers=clang-trunk-libstdc++-snapshot                                         --enable-gmp --enable-mpfr --enable-mpc --enable-isl --enable-cloog --enable-ppl --enable-icu4c=49.1.1 --with-mpi-backend=openmpi                               --enable-valgrind --concurrency=3 --with-awacs=\"${prefix}/bin/twitter.rb\" --with-stream="$log_file_full_path" >> "$log_file_full_path" 2>&1 )

( cd "${dir}" && bjam -d+2 --prefix="${prefix}" --enable-multitarget --with-binutils=2.22.51 --with-gmp-for-gcc=latest --with-mpfr-for-gcc=3.0.1  --with-mpc-for-gcc=latest --with-isl-for-gcc=system --with-cloog-for-gcc=system --enable-compilers=icc-system-libstdc++-current,icc-system-libstdc++-current-snapshot     --enable-gmp --enable-mpfr --enable-mpc --enable-isl --enable-cloog              --enable-icu4c=49.1.1 --with-mpi-backend=openmpi                --enable-clang                   --concurrency=3 --with-awacs=\"${prefix}/bin/twitter.rb\" --with-stream="$log_file_full_path" >> "$log_file_full_path" 2>&1 )

( cd "${dir}" && bjam -d+2 --prefix="${prefix}" --enable-multitarget --with-binutils=2.22.90 --with-gmp-for-gcc=latest --with-mpfr-for-gcc=latest --with-mpc-for-gcc=latest --with-isl-for-gcc=latest --with-cloog-for-gcc=latest --enable-compilers=icc-system-libstdc++-snapshot                                          --enable-gmp --enable-mpfr --enable-mpc --enable-isl --enable-cloog              --enable-icu4c=49.1.1 --with-mpi-backend=openmpi                --enable-clang                   --concurrency=3 --with-awacs=\"${prefix}/bin/twitter.rb\" --with-stream="$log_file_full_path" >> "$log_file_full_path" 2>&1 )
